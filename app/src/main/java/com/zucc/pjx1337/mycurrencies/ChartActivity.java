...
public class ChartActivity extends AppCompatActivity {
    ...
    private void generateData() {
        ...
        Cursor cursor = db.query("Chart", null, null, null, null, null, null);
        ...
        for (int i = 0; i < numberOfLines; ++i) {
            ...
            if (cursor.moveToFirst()) {
                do {
                    //遍历Cursor对象
                    Float USDnum = cursor.getFloat(cursor.getColumnIndex("USDnum"));
                    values.add(new PointValue(j, USDnum));
                    j++;
